...
You need to set two environment variables: *TUMBLR\_KEY* and *TUMBLR\_SECRET* with your OAuth key and secret you get "after registering your app with Tumblr":http://www.tumblr.com/oauth/apps.  
